...
public class ActivityHorrorParty extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_horror_party);
    ...
    public void executea() {
        ...
        do {
            ...
            if (!comprobarInferiores(piezaActual, tablero, reglas)) {
                ...
                if (direccion) {
                    tablero.moverColumnasIzquierda();
                }else{
                    tablero.moverColumnasDerecha();
                }
                tablero.actualizarTablero(piezaActual.getCoords(), piezaActual.getColor());
